...
def response_path(path):
    ...
    home_directory = os.path.abspath("webroot")
    location_path = os.path.join(home_directory, path[1:])
    ...
    if os.path.isdir(location_path):
        ...
        mime_type = mimetypes.guess_type(location_path)[0].encode()
        with open(location_path, 'rb') as my_file:
